...
const LoginScreen: React.FC<LoginScreenProps> = ({ onRegister }) => {
  ...
  return (
    <div className="min-h-screen flex w-full bg-slate-50 dark:bg-slate-900">
      ...
      <div className="hidden lg:flex flex-col justify-center w-1/2 bg-blue-600 p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl">
          <div className="mb-8 block">
            <img
               ...
               onError={(e) => { (e.target as HTMLImageElement).src = 'https://placehold.co/300x200?text=Vereador+Nego'; }}
            />
          </div>
          <h1 className="text-4xl md:text-5xl font-heading font-bold mb-6">
            Gestão de Gabinete Eficiente
          </h1>
          <p className="text-blue-100 text-lg font-sans">
            Acesse o portal e gerencie Pessoas, Requerimentos, Ocorrências e Agendas de forma centralizada e ágil.
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="assessor@gabinete.gov.br"
                    />
                  </div>
                </div>
